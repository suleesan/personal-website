      ...
      <nav className="z-10 flex w-full flex-row justify-between lg:px-8" aria-label="Global">
        <div className="inset-0 z-10 bg-transparent w-full flex flex-row justify-between py-4">
          <div className="m-1.5 p-1.5 flex flex-row justify-between items-center">
            <a href="https://www.linkedin.com/in/susan-lee-12957a217/" target="_blank" rel="noreferrer" className="mr-4 sm:mr-8 text-primary-500"><FiLinkedin size={24}/></a>
            <button onClick={() => window.location.href = 'mailto:leesusan@stanford.edu'} className="text-primary-500"><FiMail size={24}/></button>
          </div>
